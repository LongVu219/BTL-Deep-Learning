...
def save_model(model, name):
    MODEL_PATH = Path('/home/k64t/person-reid/CoLA/models')
...
def setup():
        ...
        parser.add_argument('--train_path',type=str,default='/home/k64t/person-reid/CoLA/data/original/raw/in_domain_train.tsv')
        parser.add_argument('--dev_path',type=str,default='/home/k64t/person-reid/CoLA/data/original/raw/in_domain_dev.tsv')
        ...
        parser.add_argument('--dropout_prob_attn',type=float,default=0.1)
        parser.add_argument('--dropout_prob_hidden',type=float,default=0.1)
