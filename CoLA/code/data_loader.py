...
class DataLoader(object):
        ...
        def __load_next__(self):
                ...
                input=torch.zeros(self.batch_size,max_len).long()
                input_mask=torch.zeros(self.batch_size,max_len).long()
                pos=torch.zeros(self.batch_size,max_len).long()
                answers=torch.tensor(ans_temp).long()
