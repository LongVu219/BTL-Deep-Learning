...
class LSTM(nn.Module):
        def __init__(self,input_size,hidden_size):
                ...
                self.lstm=nn.GRU(input_size,hidden_size,bidirectional=True,batch_first=True,num_layers=2)
...
class Model_B(nn.Module):
        ...
        def forward(self,input,input_mask,data=None):
                ...
                arange=torch.arange(0,input.shape[1]*input.shape[0],input.shape[1])
